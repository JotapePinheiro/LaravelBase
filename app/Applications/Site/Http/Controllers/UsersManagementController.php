...
class UsersManagementController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('usersmanagement.show-users', compact('users', 'roles'));
    ...
    public function create()
    {
        ...
        return $this->view('usersmanagement.create-user')->with($data);
    }
    ...
    public function show($id)
    {
        ...
        return $this->view('usersmanagement.show-user')->withUser($user);
    }
    ...
    public function edit($id)
    {
        ...
        return $this->view('usersmanagement.edit-user')->with($data);
    }
