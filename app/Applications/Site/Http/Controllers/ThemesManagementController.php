...
class ThemesManagementController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('themesmanagement.show-themes', compact('themes', 'users'));
    }
    ...
    {
        return $this->view('themesmanagement.add-theme');
    }
    ...
    public function show($id)
    {
        ...
        return $this->view('themesmanagement.show-theme')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return $this->view('themesmanagement.edit-theme')->with($data);
    }
